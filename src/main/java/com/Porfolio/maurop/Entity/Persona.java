...
public class Persona {
    ...
    public Persona(String nombre, String apellido, String telefono, String correo, String sobre_mi, String domicilio,
            String img, String titulo, List<Estudios> estudiosList, List<Experiencia> experienciaList,
            List<Skills> skillsList, List<Proyectos> proyectosList) {
        this.nombre = nombre;
